...
- Name: booking.spec.ts >> Formulaire de réservation >> affiche le formulaire de réservation
- Location: e2e\booking.spec.ts:11:7
...
Expected: visible
Error: strict mode violation: locator('input[name="name"]') resolved to 2 elements:
